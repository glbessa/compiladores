class Parser
{
	...
	{       
		...
		if (tokenCorrente.token == TokenType.INT)
			return new Int(Integer.parseInt(tokenCorrente.lexema));
		if (tokenCorrente.token == TokenType.FLOAT)
			return new Flo(Float.parseFloat(tokenCorrente.lexema));
